...
const facultyNavItems = [
  { id: "dashboard", label: "Dashboard", href: "/faculty/dashboard", icon: LayoutDashboard },
  { id: "lectures", label: "Lectures", href: "/faculty/lectures", icon: Video },
  { id: "live-classes", label: "Live Classes", href: "/faculty/live-classes", icon: Calendar },
  { id: "dpps", label: "DPPs", href: "/faculty/dpps", icon: FileText },
  { id: "study-materials", label: "Study Materials", href: "/faculty/study-materials", icon: FolderOpen },
];
      ...
      <div className="min-h-screen bg-gray-50 flex">
        ...
        >
          <div className="flex flex-col h-full">
            ...
            >
              {!sidebarCollapsed && (
                <Link href="/faculty/dashboard" className="flex items-center gap-2">
                  ...
                  <span className="text-xl font-bold text-gray-900">Roots Faculty</span>
                </Link>
              )}
              <button
            ...
            {/* Navigation */}
            <nav className="flex-1 py-4 px-3 overflow-y-auto" aria-label="Faculty navigation">
